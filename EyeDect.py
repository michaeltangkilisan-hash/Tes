    ...
    if results.multi_face_landmarks:
        ...
        if ear < EAR_THRESHOLD:
            ...
            if elapsed >= SLEEP_TIME_THRESHOLD and not alarm_played:
                cv2.putText(display_frame, "!!! MATA TERTUTUP TERDETEKSI !!!", (50, 80),
        ...
        cv2.putText(display_frame, f"EAR: {ear:.3f}", (10, 30),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.8,
                    (0, 255, 0) if ear >= EAR_THRESHOLD else (0, 0, 255), 2)
    else:
        start_closed_time = None
        alarm_played = False

    cv2.putText(display_frame, f"Mode: {mode_text}", (10, h - 20),
